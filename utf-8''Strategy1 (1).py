...
k1,i_point1,k2,i_point2 = initial_S1('') # please replace 0111 with your last four digit of your ID
...
centroids[np.random.choice(range(centroids.shape[0]),replace=False)]
